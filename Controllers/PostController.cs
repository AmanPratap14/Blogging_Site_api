...
namespace DotnetAPI.Controllers
{
    ...
    public class PostController : ControllerBase
    {
        ...
        {
            string sql = @"EXEC DotnetWebAPIsSchema.spPosts_Get @UserId=@UserIdParameter";
            DynamicParameters sqlParameters = new DynamicParameters();
        ...
        {
            string sql = @"EXEC DotnetWebAPIsSchema.spPosts_Upsert
        ...
        {
            string sql = @"EXEC DotnetWebAPIsSchema.spPost_Delete 
                @UserId=@UserIdParameter, 
